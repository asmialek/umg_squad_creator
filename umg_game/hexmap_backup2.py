            ...
            for axial_id in hexes:
                ...
                try:
                    ...
                    if hex_tile:
                        ...
                        successor = Node(hex_tile, q)
                    
                except IndexError:
                    continue
                successor_creation += time.time() - t
                ...
                if successor is not None:
                    ...
                    if successor.hex_tile == b:
                        ...
                        print(f' sorting = {sorting}\n successor_creation = {successor_creation}\n',
                              f'mathing = {mathing}\n list_traversal = {list_traversal}')
                        return path, closed_list

                    # successor.g = q.g + hex_geometry.cube_distance(q.hex_tile.cube_id, successor.hex_tile.cube_id)
                    
                    t = time.time()
                    successor.g = q.g + 1
                    successor.h = hex_geometry.cube_distance(successor.hex_tile.cube_id, b.cube_id)
                    ...
                    for closed_child in closed_list:
                        if successor == closed_child and successor.f > closed_child.f:
                            continue
